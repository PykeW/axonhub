...
func (s *RelayAccessService) CheckRelayAccess(_ context.Context, relay *RelayAuthContext, input RelayAccessCheckInput) (*RelayAccessDecision, error) {
	...
	// Access keeps a fast monthly preflight guard; SettleUsage is the settlement hard cap.
	...
	// Positive concurrency is enforced by RelayRuntimeService's request-scoped inflight tracker.
