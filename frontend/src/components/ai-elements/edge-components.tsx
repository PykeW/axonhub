...
export const Temporary = ({ id, sourceX, sourceY, targetX, targetY, sourcePosition, targetPosition }: EdgeProps) => {
...
export const Animated = ({ id, source, target, markerEnd, style }: EdgeProps) => {
